function getResolvedPortfolioActivationApiBaseUrl() {
...
function getPortfolioActivationApiUrl(routeName, suffix) {
    ...
    return getResolvedPortfolioActivationApiBaseUrl() + '/' + (normalizedSuffix ? normalizedRoute + '/' + normalizedSuffix : normalizedRoute);
}
