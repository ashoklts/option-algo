...
# factor, max days per request). 30/240/480 aren't native intervals on either
# broker (Kite has no 4h/8h candle, Dhan has no 30min) so they're built by
# aggregating the nearest native interval's candles in aggregate_intraday_candles.
