...
def is_simulator_order_enabled(trade: dict) -> bool:
    """
    Return True when:
      - activation_mode is 'fast-forward'
...
def _build_entry_doc(
    ...
    fields: dict, order_id: str, now: str,
) -> dict:
    qty = fields['quantity']
...
def record_entry_with_orders(
    ...
    try:
        ...
        entry_doc = _build_entry_doc(trade_id, leg_id, strategy_name, fields, entry_order_id, now)
        ...
        if sl_price:
            ...
            sl_doc = _build_sl_doc(
                ...
                sl_price, entry_order_id, sl_order_id, now,
            )
        ...
        if tp_price:
            ...
            tp_doc = _build_target_doc(
                trade_id, leg_id, strategy_name, fields,
                tp_price, entry_order_id, tp_order_id, now,
            )
