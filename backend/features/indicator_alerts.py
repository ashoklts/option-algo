...
actually fired. Each alert is locked to whichever chart resolution was
active when it was created (stored on the alert doc as indicatorResolution)
and is always checked against bars of that one resolution, independent of
any other alert or of whatever resolution the chart itself currently shows.
"""
